...
exports.getDefaultChatMode = exports.getChatModeById = exports.getAllChatModes = exports.defaultChatModes = void 0;
/**
 * Predefined chat modes/personas for the AI
 */
exports.defaultChatModes = [
    {
        id: 'default',
 ...
 */
function getAllChatModes() {
    return exports.defaultChatModes;
}
exports.getAllChatModes = getAllChatModes;
/**
 * Get a specific chat mode by ID
 */
function getChatModeById(id) {
    return exports.defaultChatModes.find(mode => mode.id === id);
}
exports.getChatModeById = getChatModeById;
/**
 * Get the default chat mode
 */
function getDefaultChatMode() {
    return exports.defaultChatModes[0];
}
exports.getDefaultChatMode = getDefaultChatMode;
